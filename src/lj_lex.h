...
/* Velo lexer tokens. */
#define TKDEF(_, __) \
  _(and) _(break) _(class) _(do) _(else) _(elseif) _(end) _(false) \
  _(for) _(function) _(goto) _(if) _(in) _(local) _(new) _(nil) _(not) _(or) \
  _(repeat) _(return) _(then) _(this) _(true) _(until) _(while) \
